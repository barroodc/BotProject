...
public class AvaSecond {
    /*
    Consider adding a line from Ava talking about how she talked to James and you said you
    were disinterested in talking about zodiac signs. Therefore deleting anything about birthdays
    for the scenario where Ava talks second. Same can be done for the reverse when James becomes
    the second one talked to.
     */
    ...
    static void birthDayIntro() throws InterruptedException, IOException {
        ...
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Ava: If James asked you about your birthday and zodiac sign already its okay");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Ava: I don't want to annoy you by making you tell me the same exact thing.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Ava: Just simply tell me yes or no if you want to be asked all of that again");
        TimeUnit.SECONDS.sleep(2);
        System.out.print("> ");
        ...
        if (answer.equals("Yes") || answer.equals("yes")){
            ...
            AvaYesToZodiac.birthMonth();
            AvaYesToZodiac.dayOfBirth();
            AvaYesToZodiac.yearOfBirth();
            AvaYesToZodiac.zodiacSign();
