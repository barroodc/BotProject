...
public class AvaYesToZodiac {
    ...
    static void zodiacSign() throws IOException, InterruptedException {
        System.out.println("Ava: You probably already know this but your Zodiac sign is: " + zodiac_sign(AvaYesToZodiac.month,AvaYesToZodiac.day));
        AvaSecondGame.gameOneIntro();
