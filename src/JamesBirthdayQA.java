...
public class JamesBirthdayQA extends ChatBot {
    ...
    static void monthOfBirth() throws InterruptedException{
        ...
        if (month.equals("May") || month.equals("may")){
            ...
            System.out.println("James: You were born in the same month as my younger sister!");
            TimeUnit.SECONDS.sleep(2);
        } else {
    ...
    static void dayOfBirth() throws InterruptedException{
        ...
        if ((month.equals("May") || month.equals("may")) && day == 27){
            ...
            System.out.println("James: You and my sister are almost twins.");
            System.out.println("James: I can't say the same for us though lol.");
            TimeUnit.SECONDS.sleep(2);
        }  else if (day == 27) {
            System.out.println("James: Lol not looking good in terms of being twins.");
            System.out.println("James: But being born on the same day is still something else we have in common.");
        } else {
    ...
    static void yearOfBirth() throws InterruptedException {
        ...
        if ((month.equals("May") || month.equals("may") && day == 27 && year == 1994)){
            ...
            System.out.println("James: Hey 2/3 isn't bad. We are practically twins. Minus that hardware and software.");
            TimeUnit.SECONDS.sleep(2);
        } else if (day != 27 && year == 1994){
            System.out.println("James: At least we you were born on the same year. Thats nothing to sneeze at.");
            TimeUnit.SECONDS.sleep(2);
